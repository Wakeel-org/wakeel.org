  ...
  const renderCaseDetail = () => (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
      ...
      <div className="mt-6 flex gap-3">
        <button 
          onClick={() => handleSaveToLibrary(selectedCase)}
          className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-lg transition-colors shadow-sm flex items-center"
          disabled={!user}
        >
        ...
        <button 
          onClick={() => handleExportResult(selectedCase)}
          className="px-4 py-2 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg transition-colors flex items-center"
        >
          <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button 
          onClick={() => handleShareResult(selectedCase)}
          className="px-4 py-2 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg transition-colors flex items-center"
        >
          <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-wrap gap-2 justify-between">
            ...
            <div className="flex gap-2">
              <button 
                onClick={(e) => {
                  e.stopPropagation();
                  handleSaveToLibrary(result);
                }}
                className="text-xs p-1 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded text-blue-600 dark:text-blue-400"
              ...
              <button 
                ...
                className="text-xs p-1 hover:bg-green-50 dark:hover:bg-green-900/20 rounded text-green-600 dark:text-green-400"
              ...
              <button 
                ...
                className="text-xs p-1 hover:bg-gray-50 dark:hover:bg-gray-700 rounded text-gray-600 dark:text-gray-400"
                title="View details"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
