  ...
  return (
    <section className="container px-4 md:px-6 py-8 md:py-16 lg:py-24">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
        {/* Main Hero Cell */}
        <Card className="col-span-1 lg:col-span-2 overflow-hidden border-2 border-foreground/15 bg-card shadow-none">
          <CardContent className="p-6 sm:p-10 lg:p-16 flex flex-col justify-center h-full relative min-h-[400px] sm:min-h-[500px]">
            <div className="relative z-10 space-y-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-4">
                <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-foreground">
                  Wakeel.org
                </h1>
          ...
          <CardContent className="p-6 sm:p-8 lg:p-10 space-y-8 sm:space-y-10 h-full flex flex-col justify-center min-h-[400px] sm:min-h-[500px]">
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="p-2 sm:p-3 rounded-lg border-2 border-primary/30 bg-primary/5 text-primary">
                  <Shield className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <h3 className="font-display text-lg sm:text-xl font-bold">Our Vision</h3>
              </div>
            ...
            <div className="border-t-2 border-foreground/10 pt-6 sm:pt-8 space-y-3 sm:space-y-4">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="p-2 sm:p-3 rounded-lg border-2 border-primary/30 bg-primary/5 text-primary">
                  <Target className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <h3 className="font-display text-lg sm:text-xl font-bold">Our Mission</h3>
              </div>
              <div className="sm:pl-16">
                <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
