...
const pricingPlans = [
  ...
  {
    name: 'Organizations',
    monthlyPrice: 'Starting from PKR 9,999',
          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <CardHeader className="text-center pb-8">
                ...
                <div className="mt-6">
                  <span className="text-4xl sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">
