      ...
      <div className="pt-16 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-4xl mx-auto text-gray-700 dark:text-gray-300">
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">2. Services Description</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">3. Account Registration</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">4. Subscription and Payment Terms</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">5. User Conduct</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">6. Intellectual Property Rights</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">7. User Content</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">8. Confidentiality and Data Security</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">9. Disclaimer of Warranties</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">10. Limitation of Liability</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">11. Indemnification</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">12. Governing Law and Jurisdiction</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">13. Changes to Terms</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800 dark:text-white">14. Contact Information</h2>
            <p>
